...
# parse request string and return method, path, http_version, headers, body
...
# validate and return encoding if valid
...
# generate response Text based on request parameters
...
def main():
    ...
    while True:
        ...
        threading.Thread(target=sendResponse, args=(client, response)).start()   # handle multiple starting multiple threads
